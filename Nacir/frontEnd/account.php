	...
	<div class="sec-banner bg0 p-t-80 p-b-50">
		<div class="container">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="password" value="<?php echo $_SESSION['password']; ?>"/>
                <span class="Error"></span>
            </div>
            
            <div class="form-group">
                <input class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04" style="min-width: 250px;height: 50px;" type="submit" name="Modifier" value="Modifier"/>
            </div>
         ...
         <form method="POST" action="desactiver.php">
            	  <div class="form-group">
                <input class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04" style="min-width: 250px;height: 50px;" type="submit" name="desactiver" value="Desctiver compte"/>
            </div>
