 ...
 require_once 'connexion.php';
        $a = $_POST['email'];
        $req= $pdo->prepare("SELECT * from user   where email='$a'");
        $req->execute();
        $user1 = $req->fetch(PDO::FETCH_ASSOC);
           ...
           <div class="container">
             ...
             <form method="POST" action="login.php" >
                <div class="preview text-center">
                    ...
                    <div class="form-group">
                      <input class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04" style="min-width: 250px;height: 50px;" type="submit" name="login" value="login"/>
                    </div>
                </div>
            </form><
        </div>
