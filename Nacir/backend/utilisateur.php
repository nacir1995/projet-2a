  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        $user2 = $pdo->query('SELECT * FROM user ORDER BY id_user DESC');
if(isset($_GET['text']) AND !empty($_GET['text'])) {
   $text = htmlspecialchars($_GET['text']);
   $user2 = $pdo->query('SELECT * FROM user WHERE address LIKE "%'.$text.'%" ORDER BY id_user DESC');
   if($user2->rowCount() == 0) {
      $user2 = $pdo->query('SELECT * FROM user WHERE address LIKE "%'.$text.'%" ORDER BY id_user DESC');
   }
}
        ...
        ?>
        <h3><i class="fa fa-angle-right"></i> Les utilisateurs  
          <form method="GET">
       ...
       <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> La liste des utilisateurs recherchée</h4><hr><table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?PHP while( $a = $user2->fetch(PDO::FETCH_ASSOC)) {?>
                   <tr>
                    
                    <td class="hidden-phone"><?php echo $a['name']; ?></td>
...
<?php } ?>
       ...
       <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> La liste des utilisateurs</h4><hr><table class="table table-striped table-advance table-hover">
